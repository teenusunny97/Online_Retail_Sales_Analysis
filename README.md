...
This project analyzes an **online retail dataset** to uncover sales patterns, identify top-selling products, and visualize revenue trends across countries and time.
...
1. **Revenue by Country** – Identify which countries generate the most revenue  
...
![Online Sales Dashboard](Online_Sales_Dashboard.png)
